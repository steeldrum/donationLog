/*! jQuery Mobile vGit Build: SHA1: f5c5c9a19ae70ae8ed49db92f265f5f9d762b143 <> Date: Mon Dec 19 13:14:42 2011 -0800 jquerymobile.com | jquery.org/license */
...
(function(a,e,b,d){function f(a){for(;a&&typeof a.originalEvent!=="undefined";)a=a.originalEvent;return a}function c(b){for(var c={},f,d;b;){f=a.data(b,o);for(d in f)if(f[d])c[d]=c.hasVirtualBinding=true;b=b.parentNode}return c}function g(){u&&(clearTimeout(u),u=0);u=setTimeout(function(){E=u=0;z.length=0;B=false;w=true},a.vmouse.resetTimerDuration)}function h(b,c,r){var e,g;if(!(g=r&&r[b])){if(r=!r)a:{for(r=c.target;r;){if((g=a.data(r,o))&&(!b||g[b]))break a;r=r.parentNode}r=null}g=r}if(g){e=c;var r=
e.type,j,h;e=a.Event(e);e.type=b;g=e.originalEvent;j=a.event.props;r.search(/mouse/)>-1&&(j=A);if(g)for(h=j.length;h;)b=j[--h],e[b]=g[b];if(r.search(/mouse(down|up)|click/)>-1&&!e.which)e.which=1;if(r.search(/^touch/)!==-1&&(b=f(g),r=b.touches,b=b.changedTouches,r=r&&r.length?r[0]:b&&b.length?b[0]:d))for(g=0,len=x.length;g<len;g++)b=x[g],e[b]=r[b];a(c.target).trigger(e)}return e}function i(b){var c=a.data(b.target,y);if(!B&&(!E||E!==c))if(c=h("v"+b.type,b))c.isDefaultPrevented()&&b.preventDefault(),
c.isPropagationStopped()&&b.stopPropagation(),c.isImmediatePropagationStopped()&&b.stopImmediatePropagation()}function m(b){var d=f(b).touches,r;if(d&&d.length===1&&(r=b.target,d=c(r),d.hasVirtualBinding))E=G++,a.data(r,y,E),u&&(clearTimeout(u),u=0),t=w=false,r=f(b).touches[0],s=r.pageX,D=r.pageY,h("vmouseover",b,d),h("vmousedown",b,d)}function k(a){w||(t||h("vmousecancel",a,c(a.target)),t=true,g())}function n(b){if(!w){var d=f(b).touches[0],r=t,e=a.vmouse.moveDistanceThreshold;t=t||Math.abs(d.pageX-
s)>e||Math.abs(d.pageY-D)>e;flags=c(b.target);t&&!r&&h("vmousecancel",b,flags);h("vmousemove",b,flags);g()}}function p(a){if(!w){w=true;var b=c(a.target),d;h("vmouseup",a,b);if(!t&&(d=h("vclick",a,b))&&d.isDefaultPrevented())d=f(a).changedTouches[0],z.push({touchID:E,x:d.clientX,y:d.clientY}),B=true;h("vmouseout",a,b);t=false;g()}}function l(b){var b=a.data(b,o),c;if(b)for(c in b)if(b[c])return true;return false}function j(){}function q(b){var c=b.substr(1);return{setup:function(){l(this)||a.data(this,
o,{});a.data(this,o)[b]=true;v[b]=(v[b]||0)+1;v[b]===1&&r.bind(c,i);a(this).bind(c,j);if(C)v.touchstart=(v.touchstart||0)+1,v.touchstart===1&&r.bind("touchstart",m).bind("touchend",p).bind("touchmove",n).bind("scroll",k)},teardown:function(){--v[b];v[b]||r.unbind(c,i);C&&(--v.touchstart,v.touchstart||r.unbind("touchstart",m).unbind("touchmove",n).unbind("touchend",p).unbind("scroll",k));var d=a(this),f=a.data(this,o);f&&(f[b]=false);d.unbind(c,j);l(this)||d.removeData(o)}}}var o="virtualMouseBindings",
y="virtualTouchID",e="vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" "),x="clientX clientY pageX pageY screenX screenY".split(" "),A=a.event.props.concat(a.event.mouseHooks?a.event.mouseHooks.props:[]),v={},u=0,s=0,D=0,t=false,z=[],B=false,w=false,C="addEventListener"in b,r=a(b),G=1,E=0;a.vmouse={moveDistanceThreshold:10,clickDistanceThreshold:10,resetTimerDuration:1500};for(var F=0;F<e.length;F++)a.event.special[e[F]]=q(e[F]);C&&b.addEventListener("click",function(b){var c=
...
q;c.bind("vmousecancel",g).bind("vmouseup",e).bind("vclick",h);q=setTimeout(function(){d(b,"taphold",a.Event("taphold"))},750)})}};a.event.special.swipe={scrollSupressionThreshold:10,durationThreshold:1E3,horizontalDistanceThreshold:30,verticalDistanceThreshold:75,setup:function(){var d=a(this);d.bind(c,function(c){function f(b){if(p){var c=b.originalEvent.touches?b.originalEvent.touches[0]:b;l={time:(new Date).getTime(),coords:[c.pageX,c.pageY]};Math.abs(p.coords[0]-l.coords[0])>a.event.special.swipe.scrollSupressionThreshold&&
b.preventDefault()}}var e=c.originalEvent.touches?c.originalEvent.touches[0]:c,p={time:(new Date).getTime(),coords:[e.pageX,e.pageY],origin:a(c.target)},l;d.bind(h,f).one(g,function(){d.unbind(h,f);p&&l&&l.time-p.time<a.event.special.swipe.durationThreshold&&Math.abs(p.coords[0]-l.coords[0])>a.event.special.swipe.horizontalDistanceThreshold&&Math.abs(p.coords[1]-l.coords[1])<a.event.special.swipe.verticalDistanceThreshold&&p.origin.trigger("swipe").trigger(p.coords[0]>l.coords[0]?"swipeleft":"swiperight");
p=l=b})})}};(function(a,b){function c(){var a=f();a!==e&&(e=a,d.trigger("orientationchange"))}var d=a(b),f,e;a.event.special.orientationchange={setup:function(){if(a.support.orientation&&a.mobile.orientationChangeEnabled)return false;e=f();d.bind("throttledresize",c)},teardown:function(){if(a.support.orientation&&a.mobile.orientationChangeEnabled)return false;d.unbind("throttledresize",c)},add:function(a){var b=a.handler;a.handler=function(a){a.orientation=f();return b.apply(this,arguments)}}};a.event.special.orientationchange.orientation=
...
(function(a,e,b){function d(a){a=a||location.href;return"#"+a.replace(/^[^#]*#?(.*)$/,"$1")}var f="hashchange",c=document,g,h=a.event.special,i=c.documentMode,m="on"+f in e&&(i===b||i>7);a.fn[f]=function(a){return a?this.bind(f,a):this.trigger(f)};a.fn[f].delay=50;h[f]=a.extend(h[f],{setup:function(){if(m)return false;a(g.start)},teardown:function(){if(m)return false;a(g.stop)}});g=function(){function g(){var b=d(),c=o(l);if(b!==l)q(l=b,c),a(e).trigger(f);else if(c!==l)location.href=location.href.replace(/#.*/,
"")+c;i=setTimeout(g,a.fn[f].delay)}var h={},i,l=d(),j=function(a){return a},q=j,o=j;h.start=function(){i||g()};h.stop=function(){i&&clearTimeout(i);i=b};a.browser.msie&&!m&&function(){var b,e;h.start=function(){if(!b)e=(e=a.fn[f].src)&&e+d(),b=a('<iframe tabindex="-1" title="empty"/>').hide().one("load",function(){e||q(d());g()}).attr("src",e||"javascript:0").insertAfter("body")[0].contentWindow,c.onpropertychange=function(){try{if(event.propertyName==="title")b.document.title=c.title}catch(a){}}};
...
setTimeout(function(){e.scrollTo(0,b);a(document).trigger("silentscroll",{x:0,y:b})},20);setTimeout(function(){a.event.special.scrollstart.enabled=true},150)},nsNormalizeDict:b,nsNormalize:function(c){return!c?void 0:b[c]||(b[c]=a.camelCase(a.mobile.ns+c))},getInheritedTheme:function(a,b){for(var d=a[0],f="",e=/ui-(bar|body)-([a-z])\b/,k,n;d;){k=d.className||"";if((n=e.exec(k))&&(f=n[2]))break;d=d.parentNode}return f||b||"a"},closestPageData:function(a){return a.closest(':jqmData(role="page"), :jqmData(role="dialog")').data("page")}});
...
a=a.parentNode}return a}function k(b){var b=a(b).closest(".ui-page").jqmData("url"),c=s.hrefNoHash;if(!b||!j.isPath(b))b=c;return j.makeUrlAbsolute(b,c)}var n=a(window),p=a("html"),l=a("head"),j={urlParseRE:/^(((([^:\/#\?]+:)?(?:(\/\/)((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?\]\[]+|\[[^\/\]@#?]+\])(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/,parseUrl:function(b){if(a.type(b)==="object")return b;b=j.urlParseRE.exec(b||"")||[];return{href:b[0]||"",hrefNoHash:b[1]||
...
d.filename,d.pathname);return f+e+g+i+(c.search||!h&&d.search||"")+c.hash},addSearchParams:function(b,c){var d=j.parseUrl(b),f=typeof c==="object"?a.param(c):c,e=d.search||"?";return d.hrefNoSearch+e+(e.charAt(e.length-1)!=="?"?"&":"")+f+(d.hash||"")},convertUrlToDataUrl:function(a){var b=j.parseUrl(a);if(j.isEmbeddedPage(b))return b.hash.split(A)[0].replace(/^#/,"");else if(j.isSameDomain(b,s))return b.hrefNoHash.replace(s.domain,"");return a},get:function(a){if(a===e)a=location.hash;return j.stripHash(a).replace(/[^\/]*\.[^\/*]+$/,
"")},getFilePath:function(b){var c="&"+a.mobile.subPageUrlKey;return b&&b.split(c)[0].split(A)[0]},set:function(a){location.hash=a},isPath:function(a){return/\//.test(a)},clean:function(a){return a.replace(s.domain,"")},stripHash:function(a){return a.replace(/^#/,"")},cleanHash:function(a){return j.stripHash(a.replace(/\?.*$/,"").replace(A,""))},isExternal:function(a){a=j.parseUrl(a);return a.protocol&&a.domain!==u.domain?true:false},hasProtocol:function(a){return/^(:?\w+:)/.test(a)},isFirstPageUrl:function(b){var b=
j.parseUrl(j.makeUrlAbsolute(b,s)),c=a.mobile.firstPage,c=c&&c[0]?c[0].id:e;return(b.hrefNoHash===u.hrefNoHash||D&&b.hrefNoHash===s.hrefNoHash)&&(!b.hash||b.hash==="#"||c&&b.hash.replace(/^#/,"")===c)},isEmbeddedPage:function(a){a=j.parseUrl(a);return a.protocol!==""?a.hash&&(a.hrefNoHash===u.hrefNoHash||D&&a.hrefNoHash===s.hrefNoHash):/^#/.test(a.href)}},q=null,o={stack:[],activeIndex:0,getActive:function(){return o.stack[o.activeIndex]},getPrev:function(){return o.stack[o.activeIndex-1]},getNext:function(){return o.stack[o.activeIndex+
...
A="&ui-state=dialog",v=l.children("base"),u=j.parseUrl(location.href),s=v.length?j.parseUrl(j.makeUrlAbsolute(v.attr("href"),u.href)):u,D=u.hrefNoHash!==s.hrefNoHash,t=a.support.dynamicBaseTag?{element:v.length?v:a("<base>",{href:s.hrefNoHash}).prependTo(l),set:function(a){t.element.attr("href",j.makeUrlAbsolute(a,s))},reset:function(){t.element.attr("href",s.hrefNoHash)}}:e,z=true,B,w,C;B=function(){var b=n;a.support.touchOverflow&&a.mobile.touchOverflowEnabled&&(b=a(".ui-page-active"),b=b.is(".ui-native-fixed")?
b.find(".ui-content"):b);return b};w=function(b){if(z){var c=a.mobile.urlHistory.getActive();if(c)b=b&&b.scrollTop(),c.lastScroll=b<a.mobile.minScrollBack?a.mobile.defaultHomeScroll:b}};C=function(){setTimeout(w,100,a(this))};n.bind(a.support.pushState?"popstate":"hashchange",function(){z=false});n.one(a.support.pushState?"popstate":"hashchange",function(){z=true});n.one("pagecontainercreate",function(){a.mobile.pageContainer.bind("pagechange",function(){var a=B();z=true;a.unbind("scrollstop",C);
a.bind("scrollstop",C)})});B().bind("scrollstop",C);a.mobile.getScreenHeight=g;a.fn.animationComplete=function(b){return a.support.cssTransitions?a(this).one("webkitAnimationEnd",b):(setTimeout(b,0),a(this))};a.mobile.path=j;a.mobile.base=t;a.mobile.urlHistory=o;a.mobile.dialogHashKey=A;a.mobile.noneTransitionHandler=function(b,c,d,f){f&&f.removeClass(a.mobile.activePageClass);d.addClass(a.mobile.activePageClass);return a.Deferred().resolve(b,c,d,f).promise()};a.mobile.defaultTransitionHandler=a.mobile.noneTransitionHandler;
a.mobile.transitionHandlers={none:a.mobile.defaultTransitionHandler};a.mobile.allowCrossDomainPages=false;a.mobile.getDocumentUrl=function(b){return b?a.extend({},u):u.href};a.mobile.getDocumentBase=function(b){return b?a.extend({},s):s.href};a.mobile._bindPageRemove=function(){var b=a(this);!b.data("page").options.domCache&&b.is(":jqmData(external-page='true')")&&b.bind("pagehide.remove",function(){var b=a(this),c=new a.Event("pageremove");b.trigger(c);c.isDefaultPrevented()||b.removeWithDependents()})};
a.mobile.loadPage=function(b,c){var d=a.Deferred(),f=a.extend({},a.mobile.loadPage.defaults,c),g=null,h=null,p=j.makeUrlAbsolute(b,a.mobile.activePage&&k(a.mobile.activePage)||s.hrefNoHash);if(f.data&&f.type==="get")p=j.addSearchParams(p,f.data),f.data=e;if(f.data&&f.type==="post")f.reloadPage=true;var l=j.getFilePath(p),o=j.convertUrlToDataUrl(p);f.pageContainer=f.pageContainer||a.mobile.pageContainer;g=f.pageContainer.children(":jqmData(url='"+o+"')");g.length===0&&o&&!j.isPath(o)&&(g=f.pageContainer.children("#"+
o).attr("data-"+a.mobile.ns+"url",o));if(g.length===0)if(a.mobile.firstPage&&j.isFirstPageUrl(l))a.mobile.firstPage.parent().length&&(g=a(a.mobile.firstPage));else if(j.isEmbeddedPage(l))return d.reject(p,c),d.promise();t&&t.reset();if(g.length){if(!f.reloadPage)return i(g,f.role),d.resolve(p,c,g),d.promise();h=g}var A=f.pageContainer,m=new a.Event("pagebeforeload"),q={url:b,absUrl:p,dataUrl:o,deferred:d,options:f};A.trigger(m,q);if(m.isDefaultPrevented())return d.promise();if(f.showLoadMsg)var v=
setTimeout(function(){a.mobile.showPageLoadingMsg()},f.loadMsgDelay);!a.mobile.allowCrossDomainPages&&!j.isSameDomain(u,p)?d.reject(p,c):a.ajax({url:l,type:f.type,data:f.data,dataType:"html",success:function(e,A,k){var m=a("<div></div>"),n=e.match(/<title[^>]*>([^<]*)/)&&RegExp.$1,s=RegExp("\\bdata-"+a.mobile.ns+"url=[\"']?([^\"'>]*)[\"']?");RegExp("(<[^>]+\\bdata-"+a.mobile.ns+"role=[\"']?page[\"']?[^>]*>)").test(e)&&RegExp.$1&&s.test(RegExp.$1)&&RegExp.$1&&(b=l=j.getFilePath(RegExp.$1));t&&t.set(l);
m.get(0).innerHTML=e;g=m.find(":jqmData(role='page'), :jqmData(role='dialog')").first();g.length||(g=a("<div data-"+a.mobile.ns+"role='page'>"+e.split(/<\/?body[^>]*>/gmi)[1]+"</div>"));n&&!g.jqmData("title")&&(~n.indexOf("&")&&(n=a("<div>"+n+"</div>").text()),g.jqmData("title",n));if(!a.support.dynamicBaseTag){var u=j.get(l);g.find("[src], link[href], a[rel='external'], :jqmData(ajax='false'), a[target]").each(function(){var b=a(this).is("[href]")?"href":a(this).is("[src]")?"src":"action",c=a(this).attr(b),
c=c.replace(location.protocol+"//"+location.host+location.pathname,"");/^(\w+:|#|\/)/.test(c)||a(this).attr(b,u+c)})}g.attr("data-"+a.mobile.ns+"url",j.convertUrlToDataUrl(l)).attr("data-"+a.mobile.ns+"external-page",true).appendTo(f.pageContainer);g.one("pagecreate",a.mobile._bindPageRemove);i(g,f.role);p.indexOf("&"+a.mobile.subPageUrlKey)>-1&&(g=f.pageContainer.children(":jqmData(url='"+o+"')"));f.showLoadMsg&&(clearTimeout(v),a.mobile.hidePageLoadingMsg());q.xhr=k;q.textStatus=A;q.page=g;f.pageContainer.trigger("pageload",
q);d.resolve(p,c,g,h)},error:function(b,e,g){t&&t.set(j.get());q.xhr=b;q.textStatus=e;q.errorThrown=g;b=new a.Event("pageloadfailed");f.pageContainer.trigger(b,q);b.isDefaultPrevented()||(f.showLoadMsg&&(clearTimeout(v),a.mobile.hidePageLoadingMsg(),a("<div class='ui-loader ui-overlay-shadow ui-body-e ui-corner-all'><h1>"+a.mobile.pageLoadErrorMessage+"</h1></div>").css({display:"block",opacity:0.96,top:n.scrollTop()+100}).appendTo(f.pageContainer).delay(800).fadeOut(400,function(){a(this).remove()})),
d.reject(p,c))}});return d.promise()};a.mobile.loadPage.defaults={type:"get",data:e,reloadPage:false,role:e,showLoadMsg:false,pageContainer:e,loadMsgDelay:50};a.mobile.changePage=function(g,h){if(x)y.unshift(arguments);else{var l=a.extend({},a.mobile.changePage.defaults,h);l.pageContainer=l.pageContainer||a.mobile.pageContainer;l.fromPage=l.fromPage||a.mobile.activePage;var m=l.pageContainer,k=new a.Event("pagebeforechange"),q={toPage:g,options:l};m.trigger(k,q);if(!k.isDefaultPrevented())if(g=q.toPage,
x=true,typeof g=="string")a.mobile.loadPage(g,l).done(function(b,c,d,f){x=false;c.duplicateCachedPage=f;a.mobile.changePage(d,c)}).fail(function(){x=false;d(true);f();l.pageContainer.trigger("pagechangefailed",q)});else{if(g[0]===a.mobile.firstPage[0]&&!l.dataUrl)l.dataUrl=u.hrefNoHash;var k=l.fromPage,n=l.dataUrl&&j.convertUrlToDataUrl(l.dataUrl)||g.jqmData("url"),v=n;j.getFilePath(n);var s=o.getActive(),D=o.activeIndex===0,t=0,w=document.title,z=l.role==="dialog"||g.jqmData("role")==="dialog";if(k&&
k[0]===g[0]&&!l.allowSamePageTransition)x=false,m.trigger("pagechange",q);else{i(g,l.role);l.fromHashChange&&o.directHashChange({currentUrl:n,isBack:function(){t=-1},isForward:function(){t=1}});try{document.activeElement&&document.activeElement.nodeName.toLowerCase()!="body"?a(document.activeElement).blur():a("input:focus, textarea:focus, select:focus").blur()}catch(C){}z&&s&&(n=(s.url||"")+A);if(l.changeHash!==false&&n)o.ignoreNextHashChange=true,j.set(n);var B=!s?w:g.jqmData("title")||g.children(":jqmData(role='header')").find(".ui-title").getEncodedText();
B&&w==document.title&&(w=B);g.jqmData("title")||g.jqmData("title",w);l.transition=l.transition||(t&&!D?s.transition:e)||(z?a.mobile.defaultDialogTransition:a.mobile.defaultPageTransition);t||o.addNew(n,l.transition,w,v,l.role);document.title=o.getActive().title;a.mobile.activePage=g;l.reverse=l.reverse||t<0;c(g,k,l.transition,l.reverse).done(function(){d();l.duplicateCachedPage&&l.duplicateCachedPage.remove();p.removeClass("ui-mobile-rendering");b(g);f();m.trigger("pagechange",q)})}}}};a.mobile.changePage.defaults=
{transition:e,reverse:false,changeHash:true,fromHashChange:false,role:e,duplicateCachedPage:e,pageContainer:e,showLoadMsg:true,dataUrl:e,fromPage:e,allowSamePageTransition:false};a.mobile._registerInternalEvents=function(){a(document).delegate("form","submit",function(b){var c=a(this);if(a.mobile.ajaxEnabled&&!c.is(":jqmData(ajax='false')")){var d=c.attr("method"),f=c.attr("target"),e=c.attr("action");if(!e&&(e=k(c),e===s.hrefNoHash))e=u.hrefNoSearch;e=j.makeUrlAbsolute(e,k(c));!j.isExternal(e)&&
...
function(b){if(a.mobile.linkBindingEnabled){var c=m(b.target);if(c&&!(b.which>1)){var f=a(c),g=function(){window.setTimeout(function(){d(true)},200)};if(f.is(":jqmData(rel='back')"))return window.history.back(),false;var h=k(f),c=j.makeUrlAbsolute(f.attr("href")||"#",h);if(!a.mobile.ajaxEnabled&&!j.isEmbeddedPage(c))g();else{if(c.search("#")!=-1)if(c=c.replace(/[^#]*#/,""))c=j.isPath(c)?j.makeUrlAbsolute(c,h):j.makeUrlAbsolute("#"+c,u.hrefNoHash);else{b.preventDefault();return}var h=f.is("[rel='external']")||
f.is(":jqmData(ajax='false')")||f.is("[target]"),i=a.mobile.allowCrossDomainPages&&u.protocol==="file:"&&c.search(/^https?:/)!=-1;h||j.isExternal(c)&&!i?g():(g=f.jqmData("transition"),h=(h=f.jqmData("direction"))&&h==="reverse"||f.jqmData("back"),f=f.attr("data-"+a.mobile.ns+"rel")||e,a.mobile.changePage(c,{transition:g,reverse:h,role:f}),b.preventDefault())}}}});a(document).delegate(".ui-page","pageshow.prefetch",function(){var b=[];a(this).find("a:jqmData(prefetch)").each(function(){var c=a(this),
...
a.mobile.urlHistory.getActive();c=d.pageUrl;a.extend(f,{role:d.role,transition:d.transition,reverse:b})}});else{o.directHashChange({currentUrl:c,isBack:function(){window.history.back()},isForward:function(){window.history.forward()}});return}c?(c=typeof c==="string"&&!j.isPath(c)?j.makeUrlAbsolute("#"+c,s):c,a.mobile.changePage(c,f)):a.mobile.changePage(a.mobile.firstPage,f)}};n.bind("hashchange",function(){a.mobile._handleHashChange(location.hash)});a(document).bind("pageshow",h);a(window).bind("throttledresize",
h)}})(jQuery);
...
this).each(function(){var c=a(this),e=c.jqmData("role"),h=c.jqmData("theme"),i=h||b.contentTheme||d==="dialog"&&f,m;c.addClass("ui-"+e);if(e==="header"||e==="footer"){var k=h||(e==="header"?b.headerTheme:b.footerTheme)||f;c.addClass("ui-bar-"+k).attr("role",e==="header"?"banner":"contentinfo");h=c.children("a");i=h.hasClass("ui-btn-left");m=h.hasClass("ui-btn-right");i=i||h.eq(0).not(".ui-btn-right").addClass("ui-btn-left").length;m||h.eq(1).addClass("ui-btn-right");b.addBackBtn&&e==="header"&&a(".ui-page").length>
...
i=this._getChildrenByTagName(f[0],"li","LI"),m=a.support.cssPseudoElement||!a.nodeName(f[0],"ol")?0:1,k={},n,p,l,j,q;m&&f.find(".ui-li-dec").remove();if(!d.theme)d.theme=a.mobile.getInheritedTheme(this.element,"c");for(var o=0,y=i.length;o<y;o++){n=i.eq(o);p="ui-li";if(b||!n.hasClass("ui-li"))l=n.jqmData("theme")||d.theme,j=this._getChildrenByTagName(n[0],"a","A"),j.length?(q=n.jqmData("icon"),n.buttonMarkup({wrapperEls:"div",shadow:false,corners:false,iconpos:"right",icon:j.length>1||q===false?false:
q||"arrow-r",theme:l}),q!=false&&j.length==1&&n.addClass("ui-li-has-arrow"),j.first().addClass("ui-link-inherit"),j.length>1&&(p+=" ui-li-has-alt",j=j.last(),q=e||j.jqmData("theme")||d.splitTheme,j.appendTo(n).attr("title",j.getEncodedText()).addClass("ui-li-link-alt").empty().buttonMarkup({shadow:false,corners:false,theme:l,icon:false,iconpos:false}).find(".ui-btn-inner").append(a(document.createElement("span")).buttonMarkup({shadow:true,corners:true,theme:q,iconpos:"notext",icon:h||j.jqmData("icon")||
d.splitIcon})))):n.jqmData("role")==="list-divider"?(p+=" ui-li-divider ui-btn ui-bar-"+c,n.attr("role","heading"),m&&(m=1)):p+=" ui-li-static ui-body-"+l;m&&p.indexOf("ui-li-divider")<0&&(l=n.is(".ui-li-static:first")?n:n.find(".ui-link-inherit"),l.addClass("ui-li-jsnumbering").prepend("<span class='ui-li-dec'>"+m++ +". </span>"));k[p]||(k[p]=[]);k[p].push(n[0])}for(p in k)a(k[p]).addClass(p).children(".ui-btn-inner").addClass(p);f.find("h1, h2, h3, h4, h5, h6").addClass("ui-li-heading").end().find("p, dl").addClass("ui-li-desc").end().find(".ui-li-aside").each(function(){var b=
...
(function(a,e){a.widget("mobile.slider",a.mobile.widget,{options:{theme:null,trackTheme:null,disabled:false,initSelector:"input[type='range'], :jqmData(type='range'), :jqmData(role='slider')"},_create:function(){var b=this,d=this.element,f=a.mobile.getInheritedTheme(d,"c"),c=this.options.theme||f,g=this.options.trackTheme||f,h=d[0].nodeName.toLowerCase(),f=h=="select"?"ui-slider-switch":"",i=d.attr("id"),m=i+"-label",i=a("[for='"+i+"']").attr("id",m),k=function(){return h=="input"?parseFloat(d.val()):
d[0].selectedIndex},n=h=="input"?parseFloat(d.attr("min")):0,p=h=="input"?parseFloat(d.attr("max")):d.find("option").length-1,l=window.parseFloat(d.attr("step")||1),j=a("<div class='ui-slider "+f+" ui-btn-down-"+g+" ui-btn-corner-all' role='application'></div>"),q=a("<a href='#' class='ui-slider-handle'></a>").appendTo(j).buttonMarkup({corners:true,theme:c,shadow:true}).attr({role:"slider","aria-valuemin":n,"aria-valuemax":p,"aria-valuenow":k(),"aria-valuetext":k(),title:k(),"aria-labelledby":m});
...
c+b+" ui-btn-corner-"+d+"' role='img'>"+a(this).getEncodedText()+"</span>").prependTo(q)}));i.addClass("ui-slider");d.addClass(h==="input"?"ui-slider-input":"ui-slider-switch").change(function(){b.mouseMoved||b.refresh(k(),true)}).keyup(function(){b.refresh(k(),true,true)}).blur(function(){b.refresh(k(),true)});a(document).bind("vmousemove",function(a){if(b.dragging)return b.mouseMoved=true,h==="select"&&q.removeClass("ui-slider-handle-snapping"),b.refresh(a),b.userModified=b.beforeStart!==d[0].selectedIndex,
...
false);this.handle.bind("keydown",function(c){var d=k();if(!b.options.disabled){switch(c.keyCode){case a.mobile.keyCode.HOME:case a.mobile.keyCode.END:case a.mobile.keyCode.PAGE_UP:case a.mobile.keyCode.PAGE_DOWN:case a.mobile.keyCode.UP:case a.mobile.keyCode.RIGHT:case a.mobile.keyCode.DOWN:case a.mobile.keyCode.LEFT:if(c.preventDefault(),!b._keySliding)b._keySliding=true,a(this).addClass("ui-state-active")}switch(c.keyCode){case a.mobile.keyCode.HOME:b.refresh(n);break;case a.mobile.keyCode.END:b.refresh(p);
break;case a.mobile.keyCode.PAGE_UP:case a.mobile.keyCode.UP:case a.mobile.keyCode.RIGHT:b.refresh(d+l);break;case a.mobile.keyCode.PAGE_DOWN:case a.mobile.keyCode.DOWN:case a.mobile.keyCode.LEFT:b.refresh(d-l)}}}).keyup(function(){if(b._keySliding)b._keySliding=false,a(this).removeClass("ui-state-active")});this.refresh(e,e,true)},refresh:function(a,d,f){(this.options.disabled||this.element.attr("disabled"))&&this.disable();var c=this.element,e=c[0].nodeName.toLowerCase(),h=e==="input"?parseFloat(c.attr("min")):
0,i=e==="input"?parseFloat(c.attr("max")):c.find("option").length-1,m=e==="input"&&parseFloat(c.attr("step"))>0?parseFloat(c.attr("step")):1;if(typeof a==="object"){if(!this.dragging||a.pageX<this.slider.offset().left-8||a.pageX>this.slider.offset().left+this.slider.width()+8)return;a=Math.round((a.pageX-this.slider.offset().left)/this.slider.width()*100)}else a==null&&(a=e==="input"?parseFloat(c.val()||0):c[0].selectedIndex),a=(parseFloat(a)-h)/(i-h)*100;if(!isNaN(a)){a<0&&(a=0);a>100&&(a=100);var k=
a/100*(i-h)+h,n=(k-h)%m;k-=n;Math.abs(n)*2>=m&&(k+=n>0?m:-m);k=parseFloat(k.toFixed(5));k<h&&(k=h);k>i&&(k=i);this.handle.css("left",a+"%");this.handle.attr({"aria-valuenow":e==="input"?k:c.find("option").eq(k).attr("value"),"aria-valuetext":e==="input"?k:c.find("option").eq(k).getEncodedText(),title:e==="input"?k:c.find("option").eq(k).getEncodedText()});e==="select"&&(k===0?this.slider.addClass("ui-slider-switch-a").removeClass("ui-slider-switch-b"):this.slider.addClass("ui-slider-switch-b").removeClass("ui-slider-switch-a"));
...
(function(a){var e=function(b){var d=b.selectID,f=b.label,c=b.select.closest(".ui-page"),e=a("<div>",{"class":"ui-selectmenu-screen ui-screen-hidden"}).appendTo(c),h=b._selectOptions(),i=b.isMultiple=b.select[0].multiple,m=d+"-button",k=d+"-menu",n=a("<div data-"+a.mobile.ns+"role='dialog' data-"+a.mobile.ns+"theme='"+b.options.theme+"' data-"+a.mobile.ns+"overlay-theme='"+b.options.overlayTheme+"'><div data-"+a.mobile.ns+"role='header'><div class='ui-title'>"+f.getEncodedText()+"</div></div><div data-"+
a.mobile.ns+"role='content'></div></div>").appendTo(a.mobile.pageContainer).page(),p=a("<div>",{"class":"ui-selectmenu ui-selectmenu-hidden ui-overlay-shadow ui-corner-all ui-body-"+b.options.overlayTheme+" "+a.mobile.defaultDialogTransition}).insertAfter(e),l=a("<ul>",{"class":"ui-selectmenu-list",id:k,role:"listbox","aria-labelledby":m}).attr("data-"+a.mobile.ns+"theme",b.options.theme).appendTo(p),j=a("<div>",{"class":"ui-header ui-bar-"+b.options.theme}).prependTo(p),q=a("<h1>",{"class":"ui-title"}).appendTo(j),
o=a("<a>",{text:b.options.closeText,href:"#","class":"ui-btn-left"}).attr("data-"+a.mobile.ns+"iconpos","notext").attr("data-"+a.mobile.ns+"icon","delete").appendTo(j).buttonMarkup(),y=n.find(".ui-content"),x=n.find(".ui-header a");a.extend(b,{select:b.select,selectID:d,buttonId:m,menuId:k,thisPage:c,menuPage:n,label:f,screen:e,selectOptions:h,isMultiple:i,theme:b.options.theme,listbox:p,list:l,header:j,headerTitle:q,headerClose:o,menuPageContent:y,menuPageClose:x,placeholder:"",build:function(){var b=
...
shadow:b.shadow!==e?b.shadow:g.jqmData("shadow"),corners:b.corners!==e?b.corners:g.jqmData("corners"),iconshadow:b.iconshadow!==e?b.iconshadow:g.jqmData("iconshadow")},b),m="ui-btn-inner",k,n,p=document.createElement(i.wrapperEls),l=document.createElement(i.wrapperEls),j=i.icon?document.createElement("span"):null;d&&d();if(!i.theme)i.theme=a.mobile.getInheritedTheme(g,"c");k="ui-btn ui-btn-up-"+i.theme;i.inline&&(k+=" ui-btn-inline");if(i.icon)i.icon="ui-icon-"+i.icon,i.iconpos=i.iconpos||"left",
n="ui-icon "+i.icon,i.iconshadow&&(n+=" ui-icon-shadow");i.iconpos&&(k+=" ui-btn-icon-"+i.iconpos,i.iconpos=="notext"&&!g.attr("title")&&g.attr("title",g.getEncodedText()));i.corners&&(k+=" ui-btn-corner-all",m+=" ui-btn-corner-all");i.shadow&&(k+=" ui-shadow");h.setAttribute("data-"+a.mobile.ns+"theme",i.theme);g.addClass(k);p.className=m;l.className="ui-btn-text";p.appendChild(l);if(j)j.className=n,p.appendChild(j);for(;h.firstChild;)l.appendChild(h.firstChild);h.appendChild(p);a.data(h,"textWrapper",
...
g-h-(e-f):c+g-h)}if(a.support.scrollTop&&(!a.support.touchOverflow||!a.mobile.touchOverflowEnabled)){var c,g,h="inline",i=false,m=null,k=false,n=true;a(function(){var c=a(document),d=a(window);c.bind("vmousedown",function(){n&&(m=h)}).bind("vclick",function(b){n&&!a(b.target).closest("a,input,textarea,select,button,label,.ui-header-fixed,.ui-footer-fixed").length&&!k&&(a.mobile.fixedToolbars.toggle(m),m=null)}).bind("silentscroll",b);(c.scrollTop()===0?d:c).bind("scrollstart",function(){k=true;m===
null&&(m=h);var b=m=="overlay";if(i=b||!!g)a.mobile.fixedToolbars.clearShowTimer(),b&&a.mobile.fixedToolbars.hide(true)}).bind("scrollstop",function(b){a(b.target).closest("a,input,textarea,select,button,label,.ui-header-fixed,.ui-footer-fixed").length||(k=false,i&&(a.mobile.fixedToolbars.startShowTimer(),i=false),m=null)});d.bind("resize updatelayout",b)});a(document).delegate(".ui-page","pagebeforeshow",function(b,d){var e=a(b.target).find(":jqmData(role='footer')"),g=e.data("id"),h=d.prevPage,
